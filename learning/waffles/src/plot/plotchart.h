...
public:
	PlotChartMaker(GClasses::sp_relation& pRelation, GClasses::GData* pData);
...
protected:
	...
	void DrawMeshLines(DoubleRect* pSourceRect, GClasses::GData* pData, GClasses::GImage* pImage, GClasses::GRect* pDestRect, unsigned int color);
