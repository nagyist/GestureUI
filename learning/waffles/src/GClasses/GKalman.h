...
public:
	...
	GData* stateCovariance() { return m_pP; }
	...
	void advance(const double* pControl, GData* pA);
	...
	/// and x is the state.
	void correct(const double* pObservation, GData* pH);
	...
	virtual void addTransitionNoise(GData* pInOutCov) = 0;
	...
	virtual void addObservationNoise(GData* pInOutCov) = 0;
};
