...
public:
	...
	/// See the comment for GSupervisedLearner::train
...
public:
	...
	static bool simplexMethod(GData* pA, const double* pB, int leConstraints, int geConstraints, const double* pC, double* pOutX);
