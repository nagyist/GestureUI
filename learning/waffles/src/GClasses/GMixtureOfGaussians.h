...
public:
	GMixtureOfGaussians(int nKernelCount, GData* pData, int nAttribute, double minVariance, GRand* pRand);
	...
	static GMixtureOfGaussians* stochasticHammer(int nMinKernelCount, int nMaxKernelCount, int nItters, int nTrials, GData* pData, int nAttribute, double minVariance, GRand* pRand);
