...
public:
	...
	void ToMatrix(const char* szFilename)
	{
		...
		int dim, n;
		for(dim = 0; dim < m_pRelation->size(); dim++)
		{
...
{
#ifdef WIN32
	ThrowError("not implemented yet for Win32");
	return 0;
#else
...
void MakeSwissRollData(GData* pData, int points, GRand* pRand)
{
